...
describe('db module', () => {
  describe('getConnections', () => {
    ...
    it('should throw an error if the API returns an error', async () => {
      ...
      await expect(db.getConnections({ startID: '8000096', destinationID: '8000105', departure: new Date('2020-03-23T22:00:00Z') })).rejects.toThrow('DB prices API returned: XML der Anfrage fehlerhaft - Ungueltige XML-Daten gefunden: s=null.');
    });
    ...
    it('should throw an error if the API returns an error with no tsys property', async () => {
      ...
      await expect(db.getConnections({ startID: '8000096', destinationID: '8000105', departure: new Date('2020-03-23T22:00:00Z') })).rejects.toThrow('DB prices API returned: Nummer des Zielbahnhofs existiert nicht');
    });
  });
